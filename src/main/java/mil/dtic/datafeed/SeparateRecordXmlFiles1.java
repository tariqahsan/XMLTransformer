...
public class SeparateRecordXmlFiles1 {
    ...
    private static void processRecordNodes(Document document) throws Exception {
        ...
        if (recordsList.getLength() > 0) {
            ...
            for (int i = 0; i < recordNodes.getLength(); i++) {
                ...
                // Get the value of the 'Record' node
                String recordValue = recordElement.getTextContent().trim();
                ...
                // Save the new document to a separate file named after the 'Record' value
                saveXmlDocument(newDocument, recordValue + ".xml");
            }
        }
    }
